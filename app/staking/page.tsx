  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="text-center">
        ...
        <h1 className="text-4xl font-bold mb-4">Staking Shit Token Now !!!</h1>
        ...
        <div className="text-lg">
          <p>
            Staked Amount: {stakedAmount} Shit Tokens 
            <img src="https://salmon-raw-harrier-526.mypinata.cloud/ipfs/QmNS12GHek4YP3jXsVjDgq3ooqwfxxnfGLA1XmgtA8RfaC" alt="Description" className="inline-block w-6 h-6 ml-2" />
          </p>
          <p>
            Current Rewards: {rewardAmount} Shit Tokens
            <img src="https://salmon-raw-harrier-526.mypinata.cloud/ipfs/QmNS12GHek4YP3jXsVjDgq3ooqwfxxnfGLA1XmgtA8RfaC" alt="Description" className="inline-block w-6 h-6 ml-2" />
          </p>
        </div>
      </div>
